...
def implement_query_model(model, prompt):
    ...
    mock_message = model.invoke(message)
    return mock_message.content


def implement_compare_models(llama33,llama4,prompt):
    """
    ...
    """
    # TODO: Your implementation here
    response1 = implement_query_model(llama4,prompt)
    response2 = implement_query_model(llama33,prompt)
    return {'llama4':response1,'llama33':response2}
...
def main():
    ...
    try:
        ...
        comparison = implement_compare_models(llama33,llama4,test_prompt)
