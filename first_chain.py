...
def main():
    print("Hello! This is my first chain")
    # print(f'{os.environ.get('OPENROUTER_API_KEY') = }')

    information: str = """
    Elon Reeve Musk (EE-lon; born June 28, 1971) is a businessman and entrepreneur known for his leadership of Tesla, SpaceX, X, and xAI. Musk has been the wealthiest person in the world since 2025; as of February 2026, Forbes estimates his net worth to be around US$852 billion.
    ...
    summary_template = """
    given the {information} about a person I want you to give:
    1. A short summary
